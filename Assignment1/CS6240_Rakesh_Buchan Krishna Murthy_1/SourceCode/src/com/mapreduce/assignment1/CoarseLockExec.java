...
public class CoarseLockExec {
	...
	public void initiateProcessing(int noOfThreads) {
		...
		for (int j = 0; j < 10; j++) {
			...
			CoarseLockWorker processingChunk[] = new CoarseLockWorker[noOfThreads];
			...
			for (int i = 0; i < noOfThreads; i++) {
				...
				// processors
				processingChunk[i] = new CoarseLockWorker(startOffset, endOffset);
		...
		System.out.println("Coarse Lock Minimum Execution Time : " + executionStats.get(0));
		System.out.println("Coarse Lock Maximum Execution Time : " + executionStats.get(9));
		System.out.println("Coarse Lock Average Execution Time : " + totalExecTime / 10);
