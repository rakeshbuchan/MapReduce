...
import static com.mapreduce.assignment1.CoarseLockExec.stationData;
...
public class CoarseLockWorker extends Thread {
	private int startIndex;
	private int endIndex;

	public CoarseLockWorker(int start, int end) {
